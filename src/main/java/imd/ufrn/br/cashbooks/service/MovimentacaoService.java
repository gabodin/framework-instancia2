...
import imd.ufrn.br.cashbooks.extensions.CategorizarGestaoPessoal;
import imd.ufrn.br.cashbooks.extensions.RegraGestaoPessoal;
import imd.ufrn.br.cashbooks.extensions.RelatorioRTF;
...
public class MovimentacaoService {
	...
	@Autowired
	private RegraGestaoPessoal regra;
	
	@Autowired
	private CategorizarGestaoPessoal categorizar;
	
	public String getRelatorio() {
		if(relatorioStategy == null) this.setRelatorioStrategy(new RelatorioRTF());
